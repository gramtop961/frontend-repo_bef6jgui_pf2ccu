        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  required
                  className="w-full rounded-md bg-slate-950/60 px-3 py-2 text-sm text-white ring-1 ring-white/10 focus:outline-none focus:ring-2 focus:ring-orange-400 placeholder:text-slate-500"
            ...
            <div className="mt-4">
              <button
                type="submit"
                className="inline-flex items-center justify-center rounded-lg bg-gradient-to-r from-orange-500 to-cyan-500 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-orange-500/10 ring-1 ring-white/10 transition-transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-orange-400"
              >
                Send message
              </button>
            </div>
            ...
            <div className="space-y-4 text-sm text-slate-300">
              ...
              <div className="flex flex-col gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-md bg-slate-950/60 px-3 py-2 ring-1 ring-white/10 hover:bg-slate-900/70 focus:outline-none focus:ring-2 focus:ring-orange-400"
                >
